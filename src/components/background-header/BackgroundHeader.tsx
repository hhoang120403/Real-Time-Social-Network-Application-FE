...
import { FaCamera, FaBriefcase, FaMapMarkerAlt, FaGraduationCap } from 'react-icons/fa';
                ...
                <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left mt-2">
                   ...
                   <div className="flex flex-col gap-2 items-center md:items-start">
                      ...
                      <div className="flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-2 text-[#65676b] text-[15px]">
                         ...
                         <span className="flex items-center gap-2"><FaMapMarkerAlt className="text-lg opacity-70" /> {user?.location || 'Việt Nam'}</span>
                         <span className="flex items-center gap-2"><FaGraduationCap className="text-lg opacity-70" /> {user?.school || 'University'}</span>
                      </div>
                   </div>
                </div>
             </div>
            ...
            <div className="fixed top-0 left-0 right-0 z-100 bg-[#0866ff] py-3 px-6 shadow-lg animate-in slide-in-from-top duration-300">
               <div className="max-w-[1250px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
                  <div className="flex items-center gap-3 text-white">
                     {showSpinner && !hasError ? <Spinner bgColor="white" /> : <div className="w-8 h-8 flex items-center justify-center bg-white/20 rounded-full text-sm">✨</div>}
